...
local scheme = {
	root = {	'_opt_root_desc',
		...
		endStatCredit  = {'num',0,{0,4},'_opt_endStatCredit_desc','ChatSend',nil,3},
		...
		downedWarning  = {'num',2,{0,4},'_opt_downedWarning_desc','ChatSend',nil,4},
		replenished  = {'num',1,{0,4},'_opt_replenished_desc','ChatSend',nil,4},
		messiah  = {'num',5,{0,5},'_opt_messiah_desc','ChatSend',nil,5},
		drillDone = {'num',1,{0,4},'_opt_drillDone_desc','ChatSend',nil,6},
		drillAlmostDone = {'num',1,{0,4},'_opt_drillAlmostDone_desc','ChatSend',nil,6},
	}, hit = {	'_opt_hit_desc',
		enable = {'bool',TRUE,nil,'_opt_enable_desc'},
